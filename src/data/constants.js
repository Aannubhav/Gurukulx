...
export const PRICING = [
  {
    ...
    description: 'Pay a small annual fee and share 8% of every sale. Perfect if you\'re just starting out.',
    features: [
  ...
  },
  {
    ...
    description: 'Buy out of the revenue share permanently. Predictable cost, full access, no per-sale deduction.',
    features: [
    ...
    highlight: true,
    badge: 'Most Popular',
    insight: 'Best at ₹25L+ GMV/yr',
  },
  {
    id: 'enterprise',
    name: 'Enterprise',
    price: '₹5,00,000',
    sub: 'One-time · Full source code',
    tagline: 'Full source code. Total independence.',
    description: 'Own the entire codebase. Modify, extend, and build your own product on top.',
    features: [
